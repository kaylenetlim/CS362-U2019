...
int refactMinion(int choice1, int choice2, struct gameState *state, int handPos) {
...
int refactMine(int choice1, int choice2, struct gameState *state, int handPos) {
  ...
  switch( card ) 
    {
	  ...
	  ///// REFACTED //////
	case mine:
	  refactMine(choice1, choice2, state, handPos);
	...
	case baron:
	  ...
	  ////// REFACTED //////
	case minion:
	  refactMinion(choice1, choice2, state, handPos);
	...
	case tribute:
	  ...
	  ////// REFACTED //////
	case ambassador:
	  refactAmbassador(choice1, choice2, state, handPos);
