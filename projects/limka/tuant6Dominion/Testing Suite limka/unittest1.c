...
int main(){
   ...
   int handPos = 0, bonus = 0, currentPlayer = 0;
   int numPlayers = 2;
   ...
   int testrun = cardEffect(baron, choice1, choice2, choice3, &teststate, handPos, &bonus); // obtain the return value of the function
   ...
   baronFunc(choice1, &teststate, currentPlayer);
