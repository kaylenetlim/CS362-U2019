...
int main(){
   ...
   int testrun = cardEffect(mine, choice1, choice2, choice3, &teststate, handPos, &bonus); // obtain the return value of the function
   ...
   printf(">>> Testing correct return value based on hand value.. ");
